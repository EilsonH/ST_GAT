...
from net_attention.utils.tgcn import ConvTemporalGraphical
from net_attention.utils.graph import Graph
from net_attention.utils.gat import GraphAttentionLayer
...
class Model(nn.Module):
    ...
    Args:
        ...
        edge_importance_weighting (bool): If ``True``, adds a learnable #可学习式权重
    ...
    def __init__(self, in_channels, num_class, graph_args, #3,400,
        ...
        self.st_gcn_networks = nn.ModuleList((
            st_gcn(in_channels, 64, kernel_size, 1, residual=False, gat=True, **kwargs0),
            st_gcn(64, 64, kernel_size, 1, **kwargs),
            st_gcn(64, 64, kernel_size, 1, **kwargs),
            st_gcn(64, 64, kernel_size, 1, **kwargs),
            st_gcn(64, 128, kernel_size, 2, gat=True, **kwargs),
            st_gcn(128, 128, kernel_size, 1, **kwargs),
            st_gcn(128, 128, kernel_size, 1, **kwargs),
            st_gcn(128, 256, kernel_size, 2, gat = True, **kwargs),
...
class st_gcn(nn.Module):
    ...
    def __init__(self,
        ...
        # self.gat = gat
        # if self.gat:
        self.att = GraphAttentionLayer(out_channels, dropout)
